...
function Initialize-SoftwareCenterTab {
    ...
    $connectionPanel.Padding = New-Object System.Windows.Forms.Padding(15, 10, 15, 10)
    
    # Computer name label
    $lblComputer = New-Object System.Windows.Forms.Label
    $lblComputer.Location = New-Object System.Drawing.Point(15, 22)
    $lblComputer.Size = New-Object System.Drawing.Size(140, 23)
    ...
    $script:ComputerTextBox.Location = New-Object System.Drawing.Point(165, 20)
    $script:ComputerTextBox.Size = New-Object System.Drawing.Size(250, 23)
    ...
    $script:ConnectButton.Location = New-Object System.Drawing.Point(425, 18)
    ...
    $script:ConnectButton.BackColor = $colorPrimary
    ...
    $script:ConnectButton.FlatAppearance.BorderSize = 0
    ...
    $script:RefreshButton.Location = New-Object System.Drawing.Point(535, 18)
    $script:RefreshButton.Size = New-Object System.Drawing.Size(100, 28)
    $script:RefreshButton.Text = "Refresh"
    $script:RefreshButton.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $script:RefreshButton.BackColor = [System.Drawing.Color]::FromArgb(39, 174, 96)
    ...
    $listPanel.Location = New-Object System.Drawing.Point(0, 72)
    $listPanel.Size = New-Object System.Drawing.Size($TabPage.Width, ($TabPage.Height - 72))
