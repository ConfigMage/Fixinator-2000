...
function Initialize-ScriptLibraryPanel {
    ...
    $colorSuccess = [System.Drawing.Color]::FromArgb(39, 174, 96)
    $colorDanger = [System.Drawing.Color]::FromArgb(231, 76, 60)
    ...
    $lblSearch.Location = New-Object System.Drawing.Point(15, 22)
    $lblSearch.Size = New-Object System.Drawing.Size(50, 23)
    ...
    $script:SearchBox.Location = New-Object System.Drawing.Point(70, 20)
    $script:SearchBox.Size = New-Object System.Drawing.Size(280, 25)
    $script:SearchBox.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $script:SearchBox.BorderStyle = [System.Windows.Forms.BorderStyle]::FixedSingle
    ...
    $btnAddScript.Location = New-Object System.Drawing.Point(365, 18)
    $btnAddScript.Size = New-Object System.Drawing.Size(110, 28)
    $btnAddScript.Text = "Add Script"
    $btnAddScript.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $btnAddScript.BackColor = $colorSuccess
    ...
    $btnAddScript.Cursor = [System.Windows.Forms.Cursors]::Hand
    ...
    $btnEditScript.Location = New-Object System.Drawing.Point(485, 18)
    $btnEditScript.Size = New-Object System.Drawing.Size(110, 28)
    $btnEditScript.Text = "Edit Script"
    $btnEditScript.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $btnEditScript.BackColor = $colorPrimary
    $btnEditScript.ForeColor = [System.Drawing.Color]::White
    $btnEditScript.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
    $btnEditScript.FlatAppearance.BorderSize = 0
    $btnEditScript.Cursor = [System.Windows.Forms.Cursors]::Hand
    ...
    $btnDeleteScript.Location = New-Object System.Drawing.Point(605, 18)
    $btnDeleteScript.Size = New-Object System.Drawing.Size(110, 28)
    $btnDeleteScript.Text = "Delete Script"
    $btnDeleteScript.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $btnDeleteScript.BackColor = $colorDanger
    $btnDeleteScript.ForeColor = [System.Drawing.Color]::White
    $btnDeleteScript.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
    $btnDeleteScript.FlatAppearance.BorderSize = 0
    $btnDeleteScript.Cursor = [System.Windows.Forms.Cursors]::Hand
    ...
    $btnCopyScript.Location = New-Object System.Drawing.Point(725, 18)
    $btnCopyScript.Size = New-Object System.Drawing.Size(140, 28)
    $btnCopyScript.Text = "Copy to Clipboard"
    $btnCopyScript.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $btnCopyScript.BackColor = [System.Drawing.Color]::FromArgb(149, 165, 166)
    $btnCopyScript.ForeColor = [System.Drawing.Color]::White
    $btnCopyScript.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
    $btnCopyScript.FlatAppearance.BorderSize = 0
    $btnCopyScript.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnCopyScript.Add_Click({
        Copy-ScriptToClipboard
    })
    $toolbar.Controls.Add($btnCopyScript)
    ...
    $splitContainer.Location = New-Object System.Drawing.Point(0, 72)
    $splitContainer.Size = New-Object System.Drawing.Size($Panel.Width, ($Panel.Height - 72))
    ...
    $script:ScriptListView.BackColor = [System.Drawing.Color]::White
    $script:ScriptListView.BorderStyle = [System.Windows.Forms.BorderStyle]::None

    # Add columns (adjusted for 350px width)
    $script:ScriptListView.Columns.Add("Name", 140) | Out-Null
    $script:ScriptListView.Columns.Add("Category", 90) | Out-Null
    $script:ScriptListView.Columns.Add("Description", 180) | Out-Null
    $script:ScriptListView.Columns.Add("Author", 80) | Out-Null
    $script:ScriptListView.Columns.Add("Date", 90) | Out-Null
    ...
    $lblPreview.Size = New-Object System.Drawing.Size(200, 25)
    $lblPreview.Text = "Script Preview"
    $lblPreview.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Bold)
    $lblPreview.ForeColor = $colorPrimary
    $previewPanel.Controls.Add($lblPreview)
    
    # Copy button (in preview panel header)
    $btnCopyPreview = New-Object System.Windows.Forms.Button
    $btnCopyPreview.Size = New-Object System.Drawing.Size(140, 28)
    $btnCopyPreview.Text = "Copy to Clipboard"
    $btnCopyPreview.Font = New-Object System.Drawing.Font("Segoe UI", 9)
    $btnCopyPreview.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Right
    $btnCopyPreview.BackColor = [System.Drawing.Color]::FromArgb(155, 89, 182)
    $btnCopyPreview.ForeColor = [System.Drawing.Color]::White
    $btnCopyPreview.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
    $btnCopyPreview.FlatAppearance.BorderSize = 0
    $btnCopyPreview.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnCopyPreview.Add_Click({
        Copy-ScriptToClipboard
    })

    # Add resize event to position button correctly
    $previewPanel.Add_Resize({
        $btnCopyPreview.Location = New-Object System.Drawing.Point(($previewPanel.Width - 150), 8)
    })

    # Set initial position
    $btnCopyPreview.Location = New-Object System.Drawing.Point(($previewPanel.Width - 150), 8)
    $previewPanel.Controls.Add($btnCopyPreview)
    
    # Preview textbox
    $script:ScriptPreviewBox = New-Object System.Windows.Forms.TextBox
    $script:ScriptPreviewBox.Location = New-Object System.Drawing.Point(10, 45)
    $script:ScriptPreviewBox.Size = New-Object System.Drawing.Size(($previewPanel.Width - 20), ($previewPanel.Height - 55))
    $script:ScriptPreviewBox.Multiline = $true
    $script:ScriptPreviewBox.ScrollBars = [System.Windows.Forms.ScrollBars]::Both
    $script:ScriptPreviewBox.BorderStyle = [System.Windows.Forms.BorderStyle]::FixedSingle
